...
import com.example.comprasexpress.activity.usuario.UsuarioSelecionaPagamentoActivity;
import com.example.comprasexpress.adapter.CarrinhoAdapter;
import com.example.comprasexpress.autenticacao.LoginActivity;
import com.example.comprasexpress.databinding.DialogRemoverCarrinhoBinding;
import com.example.comprasexpress.databinding.FragmentUsuarioCarrinhoBinding;
        ...
        dialogBinding.likeButton.setOnLikeListener(new OnLikeListener() {
            ...
            public void liked(LikeButton likeButton) {
                if (FirebaseHelper.getAutenticado()) {
                    ...
                    Toast.makeText(requireContext(), "Você não está autenticado no aplicativo.", Toast.LENGTH_SHORT).show();
