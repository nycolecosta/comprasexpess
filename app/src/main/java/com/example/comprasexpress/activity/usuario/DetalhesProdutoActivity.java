...
import com.example.comprasexpress.adapter.SliderAdapter;
import com.example.comprasexpress.databinding.ActivityDetalhesProdutoBinding;
import com.example.comprasexpress.databinding.DialogAddItemCarrinhoBinding;
        ...
        binding.likeButton.setOnLikeListener(new OnLikeListener() {
            ...
            public void liked(LikeButton likeButton) {
                if (FirebaseHelper.getAutenticado()) {
                    ...
                    Toast.makeText(getBaseContext(), "Você não está autenticado no aplicativo.", Toast.LENGTH_SHORT).show();
